...
import {
  ExpandingCards,
  buildExpandingCardItems,
} from "@/components/ui/expanding-cards";

export function ServicesSection() {
  const { siteContent } = useSiteContent();
  const items = useMemo(
    () => buildExpandingCardItems(siteContent.services),
