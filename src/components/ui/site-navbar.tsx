    ...
    <header
      className={
        absolute
          ...
          : "relative z-30 px-4 pt-5 sm:px-6 lg:px-8"
      }
    >
      <div
        className={
          absolute
            ? "mx-auto w-full max-w-7xl px-4 pt-5 sm:px-6 lg:px-8"
      ...
      >
        <motion.nav
          ...
          className="rounded-[1.6rem] border border-amber-300/35 bg-white/72 px-4 py-3 shadow-[0_16px_50px_rgba(182,117,47,0.12)] backdrop-blur-xl"
        >
            ...
            <Link to="/" className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0 text-left">
                <p className="truncate text-sm font-semibold uppercase tracking-[0.24em] text-[#b06a1f]/80">
                  {business.areaLabel} Mehndi Studio
                </p>
